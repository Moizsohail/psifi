...
class EventsPortalState extends State<EventsPortal>{
  List<EventDoc> docList = [
    ...
    EventDoc('Drogone','Demonstrate the flight capabilities of your unmanned, electric powered, radio-controlled drone that can best meet the specified mission profile.','Demonstrate the flight capabilities of your unmanned, electric powered, radio-controlled drone that can best meet the specified mission profile.','images/drogone.png','Ali Adnan Arif','Omair Faqah ur Rehman','Rana Sher Ali',' ',' ',' ','images/eh1_drogone.jpg','images/eh2_drogone.jpg','images/eh3_drogone.jpg','images/cover_drogone.png'),
    EventDoc('Galactica','A glimpse of the future, a race against time! Give the Jetsons a run for their money by reimagining your own utopian space settlement!','A glimpse of the future, a race against time! Give the Jetsons a run for their money by reimagining your own utopian space settlement!','images/galactica.png','Maham Rasheed','Abdul Monum','NONE','+92 323 1495519',' ',' ','images/eh1_galactica.jpg','images/eh2_galactica.jpg','NONE','images/cover_galactica.png'),
    ...
    EventDoc('Scifinity Wars',' ',' ','images/scifinitywars.png','Noor ul Huda Nadeem','Eesha Atif','NONE',' ',' ','NONE','images/eh1_scifinitywars.jpg','images/eh2_scifinitywars.jpg','NONE','images/cover_scifinitywars.png'),
    ...
    EventDoc('Tour De Mind','Do you think you have the skills to be a detective? Does deciphering code get your blood flowing? Three days of deciphers, RGMs and fun!','Do you think you have the skills to be a detective? Does deciphering code get your blood flowing? Then this is the event for you. Three days of deciphers, RGMs and fun!','images/tdm.png','Haram Siddique','Mahad Abdullah Shahid','NONE','0322 4520536','0307 4217321','NONE','images/eh1_tdm.jpg','images/eh2_tdm.jpg','NONE','images/cover_tdm.png'),
